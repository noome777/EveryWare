...
<body class="vertical  light  ">
        ...
        <nav aria-label="Table Paging" class="my-3">
          <ul class="pagination justify-content-center mb-0">
            <c:if test="${pv.startPage ne 1}">
              <li class="page-item"><a class="page-link" href="${root}/approval/unApprList/${pv.startPage - 1}/${selectedFormCode}">Previous</a></li>
            </c:if>
            <c:forEach begin="${pv.startPage}" end="${pv.endPage}" var="i">
              <li class="page-item"><a class="page-link" href="${root}/approval/unApprList/${i}/${selectedFormCode}">${i}</a></li>
            </c:forEach>
            <c:if test="${pv.endPage ne pv.maxPage}">
              <li class="page-item"><a class="page-link" href="${root}/approval/unApprList/${pv.endPage + 1}/${selectedFormCode}">Next</a></li>
            </c:if>
          </ul>
        </nav>
  ...
  <script>
    $('#custom-select').on('change', function () {
      ...
      location.href='${root}/approval/unApprList/1/' + docFormCode;
    })
  </script>
</body>
</html>