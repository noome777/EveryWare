       ...
       <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
               <a class="nav-link" onclick="location.href='${root}/mail/mailMain/1'">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
           <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/receive/1'">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
             <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/send/1'">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/self/1'">
             ...
             <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/trash/1'">
