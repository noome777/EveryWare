       ...
       <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
               <a class="nav-link" onclick="location.href='${root}/mail/main'">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
           <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/receive'">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
             <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/send'">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/self'">
             ...
             <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a class="nav-link" onclick="location.href='${root}/mail/trash'">
